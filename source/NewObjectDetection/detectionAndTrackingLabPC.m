...
%     pause;
    ...
    tic
     while ~ isDone(videoread)
         ...
         if countNumberFrame >= 1 % condition for specific frame of video to process
             
             if (mod(countNumberFrame, intervalShiftingFrame) == 33333)% condition for shifting the frame interval
